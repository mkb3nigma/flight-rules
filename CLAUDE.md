...
| `{TEST_COMMANDS}` | `hooks/agent/pre-commit-check.test.sh`, `hooks/git/merge-gate.test.sh`, `hooks/git/ref-gate.test.sh`, `hooks/doctor.test.sh`, `hooks/wiring.test.sh`, `skills/catalogue.test.sh` — no arguments, no network |
